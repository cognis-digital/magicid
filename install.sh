#!/usr/bin/env sh
# Universal installer for magicid. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/magicid.git"
echo "Installing magicid ..."
