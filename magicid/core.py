"""MAGICID core — Identify true file types by magic bytes (beats extensions)."""
...
RULES = [
    ("MAG-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("MAG-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("MAG-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
