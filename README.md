...
[![PyPI](https://img.shields.io/pypi/v/cognis-magicid.svg)](https://pypi.org/project/cognis-magicid/)
[![CI](https://github.com/cognis-digital/magicid/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/magicid/actions)
...
MAGICID exists for one job — identify true file types by magic bytes (beats extensions) — and does it without a SaaS bill or heavyweight setup.
...
```bash
magicid --version
magicid scan .                      # scan the current project
magicid scan . --format json
magicid scan . --fail-on high       # non-zero exit for CI gates
magicid mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **file/libmagic**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`magicid` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
